...
func main() {
	http.HandleFunc("/fetch", func(w http.ResponseWriter, r *http.Request) {
		...
		// Convertir les headers map[string]string → map[string][]string
		...
		// Aplatir les headers de réponse
	...
	log.Println("httpcloak-server is on :7878")
